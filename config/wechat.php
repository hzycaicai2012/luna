...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wxdd23fd0d27ac81e2'),         // AppID
    'secret'  => env('WECHAT_SECRET', '78773ddaaffdfcf8ad894ac3cdacd960'),     // AppSecret
    'token'   => env('WECHAT_TOKEN', 'hzycaicai2012'),          // Token
    'aes_key' => env('WECHAT_AES_KEY', 'gmsp7nRPZxHNomQJxeSMLEC2AVUEIAQYvjrFHO3tsk8'),                    // EncodingAESKey
